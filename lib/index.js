...
function getClientIpByHeader(req, header) {
  switch (header) {
    case 'x-client-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['x-client-ip'])) {
    ...
    case 'x-forwarded-for':
      {
        var xForwardedFor = getClientIpFromXForwardedFor(req === null || req === void 0 ? void 0 : req.headers['x-forwarded-for']);
    ...
    case 'cf-connecting-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['cf-connecting-ip'])) {
    ...
    case 'fastly-client-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['fastly-client-ip'])) {
    ...
    case 'true-client-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['true-client-ip'])) {
    ...
    case 'x-real-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['x-real-ip'])) {
    ...
    case 'x-cluster-client-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['x-cluster-client-ip'])) {
    ...
    case 'x-forwarded':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['x-forwarded'])) {
    ...
    case 'forwarded-for':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['forwarded-for'])) {
    ...
    case 'forwarded':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['forwarded'])) {
    ...
    case 'x-appengine-user-ip':
      {
        if (is.ip(req === null || req === void 0 ? void 0 : req.headers['x-appengine-user-ip'])) {
          return req === null || req === void 0 ? void 0 : req.headers['x-appengine-user-ip'];
        }
        break;
      }
    default:
...
function getClientIp(req) {
  ...
  if (req !== null && req !== void 0 && req.headers) {
    if (is.ip(req === null || req === void 0 ? void 0 : req.headers['Cf-Pseudo-IPv4'])) {
